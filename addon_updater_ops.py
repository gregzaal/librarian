...
def register(bl_info):
	...
	updater.repo = "librarian"

	#updater.addon = # define at top of module, must be done first

	# Website for manual addon download, optional 
	updater.website = "https://github.com/gregzaal/librarian"
	...
	updater.version_min_update = (1,0,0) # min install (>=) will install this and higher
